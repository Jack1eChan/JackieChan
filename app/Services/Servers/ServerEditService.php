...
class ServerEditService
{
    ...
    public function handle(EditServerRequest $request, Server $server)
    {
        ...
        if ($user->id != $server->owner_id) {
            throw new DisplayException('您不拥有该服务器，因此无法进行更改。');
        }
