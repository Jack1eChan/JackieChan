...
export default () => (
    <PageContentBlock title={'账户安全'} description={'管理账户日志和身份验证。'}>
        <Container css={tw`lg:grid lg:grid-cols-3 my-10`}>
            <div css={tw`flex-none w-full col-span-1`}>
                <ContentBox className={'j-right'} title={'修改密码'} showFlashes={'account:password'}>
                    <UpdatePasswordForm />
                </ContentBox>
                <ContentBox className={'j-right'} title={'设置双因素身份验证'} css={tw`mt-8`} showFlashes={'account:2fa'}>
