...
@section('content-header')
    <h1>应用 API<small>创建新的API密钥</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">管理</a></li>
        <li><a href="{{ route('admin.api.index') }}">应用 API</a></li>
        <li class="active">新建密钥</li>
    </ol>
@endsection
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">一旦您分配了权限并创建了这个密钥，您将无法编辑它。如果您以后需要进行更改，您将需要创建一个新的密钥。</p>
                    </div>
                    <div class="box-footer">
                        {{ csrf_field() }}
                        <button type="submit" class="btn btn-success btn-sm pull-right">创建密钥</button>
                    </div>
                </div>
            </div>
        </form>
