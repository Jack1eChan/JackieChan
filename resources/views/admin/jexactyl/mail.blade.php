...
@section('content-header')
    <h1>发信设置<small>配置成龙面板如何处理发送电子邮件。</small></h1>
    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="alert alert-info no-margin-bottom">
                                    此界面仅适用于使用 SMTP 作为邮件驱动程序的实例。请使用 <code>php artisan p:environment:mail</code> 命令更新您的电子邮件设置，或在环境文件中设置 <code>MAIL_DRIVER=smtp</code>。
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">请输入应通过其发送邮件的 SMTP 服务器地址。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">请输入应通过其发送邮件的 SMTP 服务器端口。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">请选择发送邮件时要使用的加密类型。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">与 SMTP 用户名配合使用的密码。留空以继续使用现有密码。要将密码设置为空值，请在字段中输入<code>!e</code>。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted small">输入一个所有外发邮件的发件人邮箱地址。</p>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">邮件发件人名称。 <span class="field-optional"></span></label>
                                    <div>
                                        <input type="text" class="form-control" name="mail:from:name" value="{{ old('mail:from:name', config('mail.from.name')) }}" />
                                        <p class="text-muted small">邮件显示的发件人名称。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
