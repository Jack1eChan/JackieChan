        ...
        <div class="col-xs-12">
            ...
            ">
                <div class="box-header with-border">
                    <i class="fa fa-code-fork"></i> <h3 class="box-title">软件版本 <small>检查成龙面板是否有更新</small></h3>
                </div>
                <div class="box-body">
                    @if ($version->isLatestPanel())
                        您当前运行的成龙面板 <code>{{ config('app.version') }}</code>.
                    @else
                        当前成龙面板不是最新版 <code>{{ config('app.version') }} (当前) -> <a href="https://github.com/jexactyl/jexactyl/releases/v{{ $version->getPanel() }}" target="_blank">{{ $version->getPanel() }}</a> (最新)</code>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <div class="col-xs-12 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="padding: 23px 10px 0;">
                        <span class="info-box-text">全部服务器</span>
            ...
            <div class="col-xs-12 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="padding: 23px 10px 0;">
                        <span class="info-box-text">全部端口</span>
            ...
            <div class="col-xs-12 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="padding: 23px 10px 0;">
                        <span class="info-box-text">全部内存使用量</span>
            ...
            <div class="col-xs-12 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content" style="padding: 23px 10px 0;">
                        <span class="info-box-text">全部磁盘使用量</span>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <i class="fa fa-bar-chart"></i> <h3 class="box-title">资源利用情况 <small>查看已使用的总资源量的概览。</small></h3>
                </div>
                <div class="box-body">
                    <div class="col-xs-12 col-md-4">
                        <canvas id="servers_chart" width="100%" height="50">
                            <p class="text-muted">此图表没有可用的数据。</p>
                        </canvas>
                    </div>
                    <div class="col-xs-12 col-md-4">
